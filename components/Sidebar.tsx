...
export default function Sidebar({ 
  ...
  return (
    <>
      ...
      >
        {/* Sidebar Header */}
        <div className={`h-16 flex items-center justify-between border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white ${isCollapsed ? 'px-3' : 'px-5'}`}>
          <div className={`flex items-center ${isCollapsed ? 'justify-center w-full' : 'gap-3'}`}>
            ...
            {!isCollapsed && (
              <div className="overflow-hidden">
                <h2 className="text-sm font-bold text-slate-900 tracking-tight">Reports</h2>
                <p className="text-[10px] text-slate-500 uppercase tracking-wider font-medium">Fleet Dashboard</p>
              </div>
            )}
          </div>
          {!isCollapsed && (
        ...
        <div className={`hidden lg:flex items-center border-b border-slate-100 ${isCollapsed ? 'justify-center p-2' : 'justify-end px-3 py-2'}`}>
          <button
                    ...
                    >
                      <div className={`
                        ...
                        ${hasActiveReport 
                          ...
                          : `${category.bgColor} ${category.color} group-hover:opacity-80`
                        }
                      `}>
                      ...
                      {!isCollapsed && (
                        <>
                          ...
                          <div className={`
                            ...
                            ${isExpanded ? 'bg-slate-100 rotate-0' : 'bg-transparent -rotate-90'}
                          `}>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className={`
                                ...
                                transition-all duration-200
                                ${isActive ? 'bg-white/50' : 'bg-transparent group-hover:bg-slate-300'}
                              `} />
        ...
        {/* Sidebar Footer */}
        <div className={`border-t border-slate-100 bg-gradient-to-r from-slate-50/50 to-white ${isCollapsed ? 'p-2' : 'p-4'}`}>
          {isCollapsed ? (
            ...
            <div className="flex items-center justify-between text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-500 font-medium">System Active</span>
              </div>
              <span className="px-2 py-1 bg-slate-100 text-slate-600 rounded-md font-semibold">
